...
You can transform and use operators to create other ```vectors```. 

<span style="color:orangered">**_Practice_**:</span> Explore the difference between `vec4` and `vec5`. How was the addition done in both cases? 
...
In this settingm it's a good idea to create a README text file that describes your project and keep it in the project
folder. 
...
[Rmarkdown](http://rmarkdown.rstudio.com) for using a productive notebook interface to weave together narrative text and code to produce elegantly formatted output
...
<span style="color:orangered">Note:</span> The code below will only work once you install ffmpeg, ImageMagick, or other such drivers. See the [animation](https://github.com/dgrtwo/gganimate) package documentation for more details.
...
###<span style="color:orangered">**Practice**:</span> Get started by opening the **Discrete_Model.R** script
...
###<span style="color:orangered">**Practice**:</span> Get started by opening the **Continuous_Model.R** script
...
###<span style="color:orangered">**Practice**:</span> Get started by opening the **SIR_Deterministic.R** script
