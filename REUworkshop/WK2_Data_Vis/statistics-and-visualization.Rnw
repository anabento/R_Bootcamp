...
load('data.RData')       # load data sets
@ 
...
<<fig=T>>=
plot(flu$flu,flu$day, type='b',xlab='Day',ylab='Number of individuals infected')
@ 
...
<<fig=T>>=
plot(y=flu$flu,x=flu$day, type='b',xlab='Day',ylab='Number of individuals infected')
@ 
...
<<width=6, height=3, fig=TRUE, echo=FALSE>>=
require(mvtnorm)
